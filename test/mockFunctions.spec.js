...
describe('verifica as funções e os mocks', () => {
  ...
  mockFunctions.factorial.mockImplementation((data) => {
    //A implementação dessa função foi feita com a ajuda de um tutorial.
    if (data < 0) return -1;
    else if (data == 0) return 1;
    else {
      return (data * mockFunctions.factorial(data - 1));
    }
  });
