...
describe("verifica as funções e os mocks", () => {
  ...
  test("testa função add", () => {
    mockFunctions.add = jest.fn((value01, value02) => value01 + value02);
  ...
  test("testa função subtract", () => {
    mockFunctions.subtract = jest.fn((value01, value02) => value01 - value02);
  ...
  test("testa função multiply", () => {
    mockFunctions.multiply = jest.fn((value01, value02) => value01 * value02);
  ...
  test("testa função divide", () => {
    mockFunctions.divide = jest.fn((value01, value02) => value01 / value02);
  ...
  test("testa função power", () => {
    mockFunctions.power = jest.fn((value01, value02) => value01 ** value02);
  ...
  test("testa função factorial", () => {
    mockFunctions.factorial = jest.fn((value) =>
      value <= 0 ? 1 : value * mockFunctions.factorial(value - 1)
    );
