...
describe('quem sobreviveu?', () => {
  ...
  beforeEach(() => {
    ...
    console.log('Aventureiros restantes: ', adventure.specialists.map(specialist => specialist.nome));
  });
  
  afterAll(() => {
    console.log(`O avetureiro que sobreviveu foi: ${adventure.specialists[0].nome}`)
  })
