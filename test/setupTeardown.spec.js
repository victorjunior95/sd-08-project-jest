...
describe('quem sobreviveu?', () => {
  ...
  afterEach(() => {
    console.log(`${adventure.specialists.nome}, a morte ainda não chegou para vocês`)
  })

  afterAll(() => {
    console.log(`${adventure.specialists[0].nome}, a morte não te viu, parabéns pela capa de invisibilidade`)
  })
