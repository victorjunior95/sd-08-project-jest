...
describe('quem sobreviveu?', () => {
  beforeEach(() => {
    ...
    if (adventure.specialists.length > 1) {
      console.log(`Restam ${adventure.specialists.length} sobreviventes.`);
    } else {
      console.log(`${adventure.specialists[0].nome} o ${adventure.specialists[0].classe}, sobreviveu a aventura!`);
    };
  });
