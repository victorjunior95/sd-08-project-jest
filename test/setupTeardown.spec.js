...
describe('quem sobreviveu?', () => {
  beforeEach(() => {
    ...
    console.log(adventure.specialists.map((aventureiro) => aventureiro.nome));
  })
  ...
  console.log(`Congratulações ${adventure.specialists[0].nome}, você realmente é um héroi lendário!`);
});
