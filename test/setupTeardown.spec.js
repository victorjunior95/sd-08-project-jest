...
describe('quem sobreviveu?', () => {
  ...
  beforeEach(() => {
    ...
    console.log('Aventureiros restantes: ', adventure.specialists.map(specialists => specialists.name));
  });

  afterEach(() => {
    console.log(`Aventureiros restantes é ${adventure.specialists[0].name}`);
  });
